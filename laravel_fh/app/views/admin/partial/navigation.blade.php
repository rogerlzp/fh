	...
	<div class="container">
		...
		<div class="collapse navbar-collapse header-collapse">
			<ul class="nav navbar-nav">
			    ...
			    <li class="dropdown" >
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">{{ trans('admin.security') }} <b class="caret"></b>
				</a>
			    <ul class="dropdown-menu">
				<li> <a href="{{URL::route('admin.permission.index') }}">{{ trans('admin.permission')}}</a></li>
				<li> <a href="{{URL::route('admin.role.index') }}">{{ trans('admin.role')}}</a></li>
			    </ul>
			    </li>
