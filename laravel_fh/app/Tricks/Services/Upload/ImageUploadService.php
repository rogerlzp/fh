...
class ImageUploadService
{
     ...
     * @var string
     */
    protected $image_directory = 'img/temp';
     ...
     * @return boolean
     */
    public function handleImage(UploadedFile $file)
    {
    	Log::info('handleImage');
    	$mime     = $file->getMimeType();
    	$filename = $this->makeFilename();
    	$path     = $this->getFullPath($this->image_directory . '/' . $filename);
    	Log::info('path'.$path);
    
    	$success = Image::make($file->getRealPath())->save($path);
