...
class CategoryRepository extends AbstractRepository implements CategoryRepositoryInterface
{
    ...
    /**
     * Find all categories with the associated number of activity.
     *
     * @return \Illuminate\Database\Eloquent\Collection|\Tricks\Activity[]
     */
    public function findAllWithActivityCount()
    {
        return $this->model->leftJoin('activity_category', 'categories.id', '=', 'activity_category.category_id')
                           ->leftJoin('activity', 'activity.id', '=', 'activity_category.activity_id')
