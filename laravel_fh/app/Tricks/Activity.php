...
class Activity extends Model
{
	 ...
	 * @var string
	 */
	public $presenter = 'Tricks\Presenters\ActivityPresenter';
    ...
    /**
     * Query the tags under which the activity was posted.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
	...
	/**
	 * Query the categories under which the activity was posted.
	 *
	 * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
	 */
